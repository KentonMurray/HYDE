...
def simulate():
	...
	R5 = RAIDinterface.RAID5(RAIDtype=0, disknumber=10, flashpercent=0.2, SSDcapacity=250, HDDcapacity=500, blocksize=4096)

	# Distribution of possible operations
	action_set = ["write","read","write","read","read","write","write","read","delete"]
